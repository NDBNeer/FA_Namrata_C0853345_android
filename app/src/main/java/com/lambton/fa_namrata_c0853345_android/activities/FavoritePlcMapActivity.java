...
public class FavoritePlcMapActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerDragListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_favmaps);
        ...
        class SaveExpense extends AsyncTask<Void, Void, Void> {
            ...
            protected Void doInBackground(Void... voids) {
               ...
               obj.setName(completeAddressString);
                ...
                DatabaseClient.getInstance(FavoritePlcMapActivity.this).getAppDatabase()
                        .addExpenseDao()
                        .update(obj);
                return null;
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                Toast.makeText(FavoritePlcMapActivity.this, "UPDATED", Toast.LENGTH_LONG).show();
                startActivity(new Intent(FavoritePlcMapActivity.this,FavoritePlcMapActivity.class));
                finish();
            }
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 100 && resultCode == RESULT_OK) {
            ...
            Toast.makeText(FavoritePlcMapActivity.this, status.getStatusMessage(), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Places.initialize(FavoritePlcMapActivity.this, getString(R.string.google_maps_key));
    ...
    private String getCompleteAddressString(double LATITUDE, double LONGITUDE) {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(FavoritePlcMapActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
        }
        return strAdd;
    }
